...
keymap('n', '<space>h', '<Cmd>lua vim.lsp.buf.hover()<CR>', opts)
...
require("flutter-tools").setup {
  ...
  flutter_path = "/Users/takanorifukuyama/.SDK/flutter/bin/flutter", -- <-- this takes priority over the lookup
  ...
  lsp = {
    ...
    settings = {
      ...
      analysisExcludedFolders = {
        flutter_path = "/Users/takanorifukuyama/.SDK/flutter/bin/flutter"
      }
    }
  }
}
